...
class TreeNode1(TreeNode):
    def __init__(self, text, offset, elements):
        ...
        self.vis = elements[5]
        self.curwx = elements[6]
        self.skyc = elements[7]
        self.temp_dewp = elements[8]
        self.altim = elements[9]
        self.remarks = elements[10]
        self.end = elements[11]
...
class TreeNode9(TreeNode):
    def __init__(self, text, offset, elements):
        ...
        self.sep = elements[0]
        self.temp = elements[1]
        self.dewp = elements[3]
...
class Grammar(object):
                    ...
                    if address4 is not FAILURE:
                        ...
                        if address5 is not FAILURE:
                            ...
                            if address6 is not FAILURE:
                                ...
                                address7 = FAILURE
                                address7 = self._read_curwx()
                                if address7 is not FAILURE:
                                    elements0.append(address7)
                                    address8 = FAILURE
                                    address8 = self._read_skyc()
                                    if address8 is not FAILURE:
                                        elements0.append(address8)
                                        address9 = FAILURE
                                        address9 = self._read_temp_dewp()
                                        if address9 is not FAILURE:
                                            elements0.append(address9)
                                            address10 = FAILURE
                                            address10 = self._read_altim()
                                            if address10 is not FAILURE:
                                                elements0.append(address10)
                                                address11 = FAILURE
                                                address11 = self._read_remarks()
                                                if address11 is not FAILURE:
                                                    elements0.append(address11)
                                                    address12 = FAILURE
                                                    address12 = self._read_end()
    ...
    def _read_vis(self):
        ...
        if address1 is not FAILURE:
            ...
            if address2 is FAILURE:
                ...
                if self._offset < self._input_size:
                    chunk4 = self._input[self._offset:self._offset + 1]
                if chunk4 is not None and Grammar.REGEX_23.search(chunk4):
                    address7 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
                    self._offset = self._offset + 1
                else:
                    address7 = FAILURE
                ...
                if address7 is not FAILURE:
                    ...
                    if self._offset < self._input_size:
                        chunk5 = self._input[self._offset:self._offset + 1]
                    if chunk5 is not None and Grammar.REGEX_24.search(chunk5):
                        address8 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
                        self._offset = self._offset + 1
                    else:
                        address8 = FAILURE
                    ...
                    if address8 is FAILURE:
                        ...
                        if address10 is not FAILURE:
                            ...
                            if chunk7 is not None and Grammar.REGEX_25.search(chunk7):
                        ...
                        if elements4 is None:
                            ...
                            address9 = TreeNode(self._input[index10:self._offset], index10, elements4)
                            self._offset = self._offset
                        ...
                        if address9 is not FAILURE:
                            ...
                            if address12 is not FAILURE:
                                ...
                                if chunk9 is not None and Grammar.REGEX_26.search(chunk9):
                        ...
                        if elements3 is None:
                            ...
                            address8 = TreeNode(self._input[index8:self._offset], index8, elements3)
                            self._offset = self._offset
                        if address8 is FAILURE:
                            self._offset = index7
                    if address8 is FAILURE:
                    ...
                    if address8 is not FAILURE:
                        ...
                        if chunk10 == 'SM':
                            address14 = TreeNode(self._input[self._offset:self._offset + 2], self._offset)
                            self._offset = self._offset + 2
                        else:
                            address14 = FAILURE
                            if self._offset > self._failure:
    ...
    def _read_wx(self):
        ...
        if self._offset < self._input_size:
            chunk0 = self._input[self._offset:self._offset + 1]
        if chunk0 is not None and Grammar.REGEX_27.search(chunk0):
            address1 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
            self._offset = self._offset + 1
        else:
            address1 = FAILURE
    ...
    def _read_intense(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['intense'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1 = self._offset
        ...
        if self._offset < self._input_size:
            chunk0 = self._input[self._offset:self._offset + 1]
        if chunk0 is not None and Grammar.REGEX_28.search(chunk0):
        ...
        if address0 is FAILURE:
            address0 = TreeNode(self._input[index1:index1], index1)
            self._offset = index1
        self._cache['intense'][index0] = (address0, self._offset)
        return address0

    def _read_descrip(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['descrip'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1 = self._offset
                        ...
                        if address0 is FAILURE:
                            ...
                            if address0 is FAILURE:
                                ...
                                if address0 is FAILURE:
                                    ...
                                    if address0 is FAILURE:
                                        self._offset = index1
        self._cache['descrip'][index0] = (address0, self._offset)
        return address0

    def _read_precip(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['precip'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1 = self._offset
                        ...
                        if address0 is FAILURE:
                            ...
                            if address0 is FAILURE:
                                ...
                                if address0 is FAILURE:
                                    ...
                                    if address0 is FAILURE:
                                        self._offset = index1
        self._cache['precip'][index0] = (address0, self._offset)
        return address0

    def _read_obscure(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['obscure'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1 = self._offset
                            ...
                            if address0 is FAILURE:
                                ...
                                if address0 is FAILURE:
                                    ...
                                    if address0 is FAILURE:
                                        ...
                                        if address0 is FAILURE:
                                            self._offset = index1
        self._cache['obscure'][index0] = (address0, self._offset)
        return address0

    def _read_other(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['other'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1 = self._offset
        ...
        if address0 is FAILURE:
            address0 = TreeNode(self._input[index1:index1], index1)
            self._offset = index1
        self._cache['other'][index0] = (address0, self._offset)
        return address0
    ...
    def _read_cover(self):
        ...
        if address1 is not FAILURE:
            ...
            while address3 is not FAILURE:
                ...
                if self._offset < self._input_size:
                    chunk4 = self._input[self._offset:self._offset + 1]
                if chunk4 is not None and Grammar.REGEX_29.search(chunk4):
                    address3 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
                    self._offset = self._offset + 1
                else:
                    address3 = FAILURE
        ...
        if address0 is FAILURE:
            ...
            if address0 is FAILURE:
                ...
                chunk8 = None
                if self._offset < self._input_size:
                    chunk8 = self._input[self._offset:self._offset + 3]
                if chunk8 == 'SKC':
                    address0 = TreeNode(self._input[self._offset:self._offset + 3], self._offset)
                    self._offset = self._offset + 3
                else:
    ...
    def _read_dewp(self):
        ...
        if self._offset < self._input_size:
            chunk0 = self._input[self._offset:self._offset + 1]
        if chunk0 is not None and Grammar.REGEX_33.search(chunk0):
            address1 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
            self._offset = self._offset + 1
        else:
            address1 = FAILURE
        ...
        if address1 is not FAILURE:
            ...
            if self._offset < self._input_size:
                chunk1 = self._input[self._offset:self._offset + 1]
            if chunk1 is not None and Grammar.REGEX_34.search(chunk1):
                address2 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
                self._offset = self._offset + 1
            else:
                address2 = FAILURE
            ...
            if address2 is not FAILURE:
                ...
                if self._offset < self._input_size:
                    chunk2 = self._input[self._offset:self._offset + 1]
                if chunk2 is not None and Grammar.REGEX_35.search(chunk2):
                    address3 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
                    self._offset = self._offset + 1
                else:
                    address3 = FAILURE
    ...
    def _read_altim(self):
        ...
        if address1 is not FAILURE:
            ...
            if self._offset < self._input_size:
                chunk0 = self._input[self._offset:self._offset + 1]
            if chunk0 is not None and Grammar.REGEX_36.search(chunk0):
                address2 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
                self._offset = self._offset + 1
            else:
                address2 = FAILURE
            ...
            if address2 is not FAILURE:
                ...
                if self._offset < self._input_size:
                    chunk1 = self._input[self._offset:self._offset + 1]
                if chunk1 is not None and Grammar.REGEX_37.search(chunk1):
                    address3 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
                    self._offset = self._offset + 1
                else:
                    address3 = FAILURE
                ...
                if address3 is not FAILURE:
                    ...
                    if self._offset < self._input_size:
                        chunk2 = self._input[self._offset:self._offset + 1]
                    if chunk2 is not None and Grammar.REGEX_38.search(chunk2):
                        address4 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
                        self._offset = self._offset + 1
                    else:
                        address4 = FAILURE
                    ...
                    if address4 is not FAILURE:
                        ...
                        if self._offset < self._input_size:
                            chunk3 = self._input[self._offset:self._offset + 1]
                        if chunk3 is not None and Grammar.REGEX_39.search(chunk3):
                            address5 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
                            self._offset = self._offset + 1
                        else:
                            address5 = FAILURE
                        ...
                        if address5 is not FAILURE:
                            ...
                            if self._offset < self._input_size:
                                chunk4 = self._input[self._offset:self._offset + 1]
                            if chunk4 is not None and Grammar.REGEX_40.search(chunk4):
                                address6 = TreeNode(self._input[self._offset:self._offset + 1], self._offset)
                                self._offset = self._offset + 1
                            else:
                                address6 = FAILURE
